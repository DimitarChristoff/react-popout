...
const container_id = Symbol('containerid')
/**
 * @class PopoutWindow
 */
export default class PopoutWindow extends React.Component {
  ...
  constructor(props){
    ...
    this[container_id] = props.containerId || 'popout-content-container';
    this.defaultOptions = {
      toolbar: 'no',
      location: 'no',
      directories: 'no',
  ...
  componentWillReceiveProps(props){
    props.containerId && (this[container_id] = props.containerId);
  }
  ...
  componentDidMount(){
    ...
    const onloadHandler = () =>{
      if (container){
        if (win.document.getElementById(this[container_id])) return;
